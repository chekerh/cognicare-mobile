class AppConstants {
  ...
  /// List volunteer users for starting conversations (GET). Requires JWT.
  static const String usersVolunteersEndpoint = '/api/v1/users/volunteers';
  ...
  static String communityMemberContactEndpoint(String userId) =>
      '/api/v1/community/members/$userId/contact-info';
  static String communityMemberPublicInfoEndpoint(String userId) =>
      '/api/v1/community/members/$userId/public-info';
  ...
  static const String volunteerCommunityMemberProfileRoute =
      '/volunteer/community/community-member-profile';
