...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get onboardingWelcomeDescription =>
      'رحلتك نحو صحة معرفية أفضل تبدأ هنا. نحن نقدم رعاية مخصصة ودعماً لتطويرك المعرفي.';
  ...
  String get onboardingFeaturesDescription =>
      'الوصول إلى تمارين مخصصة، تتبع تقدمك، والتواصل مع متخصصي الرعاية الصحية الذين يفهمون احتياجاتك.';
  ...
  String get onboardingAccessibilityDescription =>
      'تم تصميم تطبيقنا مع وضع إمكانية الوصول في الاعتبار، مع دعم لغات متعددة وضمان أن يستفيد الجميع من الرعاية المعرفية.';
  ...
  String get signupSubtitle =>
      'انضم إلى CogniCare لبدء رحلة الرعاية المعرفية المخصصة';
  ...
  String completedAllLevels(int maxLevel) =>
      'لقد أكملت $maxLevel مستويات من تتبع النجوم!';
  ...
  String get greetingWhenHappy =>
      '{name}، يا له من ابتسامة جميلة! تبدو سعيداً!';
  @override
  String get greetingWhenSad => '{name}، نحن هنا من أجلك. هل تريد اللعب معاً؟';
  @override
  String get greetingWhenAngry =>
      '{name}، من الطبيعي أن تشعر بالإحباط. تنفس معي.';
  @override
  String get greetingWhenTired =>
      '{name}، تبدو متعباً. هل تريد أخذ استراحة هادئة؟';
  @override
  ...
  String get securityCodeRequiredToExitChildMode =>
      'سيكون هذا الرمز مطلوباً للخروج من وضع الطفل';
  @override
  ...
  String completeXMoreTasksToUnlock(int count) =>
      'أكمل $count مهام لفتح ملصق جديد!';
  ...
  String get childProfileSpecialNotesHint =>
      'محفزات محددة أو تقنيات مهدئة مفضلة...';
  @override
  ...
  String get childProfileAlertMessage =>
      'يرجى إكمال ملف الطفل للوصول إلى جميع الميزات.';
  @override
