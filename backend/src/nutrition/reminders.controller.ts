...
export class RemindersController {
  ...
  async getRemindersByChildId(
    ...
    return await this.remindersService.findByChildId(childId, req.user.id as string);
  }
  ...
  async getTodayReminders(
    ...
    return await this.remindersService.getTodayReminders(childId, req.user.id as string);
  }
  ...
  async updateReminder(
    ...
    return await this.remindersService.update(reminderId, dto, req.user.id as string);
  }
  ...
  async deleteReminder(
    ...
    return await this.remindersService.delete(reminderId, req.user.id as string);
  }
