...
export class NutritionPlanEntity extends Entity<string> {
  ...
  static create(
    props: Omit<NutritionPlanProps, "isActive" | "createdAt" | "updatedAt">,
    id?: string,
  ): NutritionPlanEntity {
    return new NutritionPlanEntity(id ?? Entity.generateId(), {
      ...props,
      isActive: true,
    });
  }
  ...
  get dailyWaterGoal() {
    return this.props.dailyWaterGoal;
  }
  get waterReminderInterval() {
    return this.props.waterReminderInterval;
  }
  get breakfast() {
    return this.props.breakfast;
  }
  get breakfastTime() {
    return this.props.breakfastTime;
  }
  get lunch() {
    return this.props.lunch;
  }
  get lunchTime() {
    return this.props.lunchTime;
  }
  get dinner() {
    return this.props.dinner;
  }
  get dinnerTime() {
    return this.props.dinnerTime;
  }
  get snacks() {
    return this.props.snacks;
  }
  get allergies() {
  ...
  get specialNotes() {
    return this.props.specialNotes;
  }
  get isActive() {
...
export class TaskReminderEntity extends Entity<string> {
  ...
  static create(
    props: Omit<TaskReminderProps, "completionHistory" | "isActive">,
    id?: string,
  ): TaskReminderEntity {
  ...
  get intervalMinutes() {
    return this.props.intervalMinutes;
  }
  get daysOfWeek() {
    return this.props.daysOfWeek;
  }
  get soundEnabled() {
    return this.props.soundEnabled;
  }
  get vibrationEnabled() {
    return this.props.vibrationEnabled;
  }
  ...
  get linkedNutritionPlanId() {
    return this.props.linkedNutritionPlanId;
  }
  get createdAt() {
    return this.props.createdAt;
  }
  ...
  setVerification(
    ...
    if (index >= 0 && index < this.props.completionHistory.length) {
      ...
      if (metadata)
        this.props.completionHistory[index].verificationMetadata = metadata;
    }
  }
}
