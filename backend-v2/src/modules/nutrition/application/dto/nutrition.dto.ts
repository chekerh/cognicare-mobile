...
export class UpdateNutritionPlanDto extends CreateNutritionPlanDto {
  ...
  @ApiPropertyOptional() @IsOptional() declare childId: string;
}
...
export class UpdateTaskReminderDto extends CreateTaskReminderDto {
  @ApiPropertyOptional() @IsOptional() @IsBoolean() isActive?: boolean;
  @ApiPropertyOptional() @IsOptional() declare childId: string;
  @ApiPropertyOptional() @IsOptional() declare type: ReminderType;
  @ApiPropertyOptional() @IsOptional() declare title: string;
  @ApiPropertyOptional() @IsOptional() declare frequency: ReminderFrequency;
}
