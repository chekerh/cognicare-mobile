...
import {
  BadgeMongoSchema, ChildBadgeMongoSchema, PointsMongoSchema, GameSessionMongoSchema,
} from './infrastructure/persistence/mongo/gamification.schema';
import {
  BadgeMongoRepository, ChildBadgeMongoRepository, PointsMongoRepository, GameSessionMongoRepository,
} from './infrastructure/persistence/mongo/gamification.mongo-repository';
import {
  BADGE_REPOSITORY_TOKEN, CHILD_BADGE_REPOSITORY_TOKEN,
  POINTS_REPOSITORY_TOKEN, GAME_SESSION_REPOSITORY_TOKEN,
  RecordGameSessionUseCase, GetChildStatsUseCase, InitializeDefaultBadgesUseCase,
...
@Module({
  ...
  providers: [
    ...
    { provide: CHILD_BADGE_REPOSITORY_TOKEN, useClass: ChildBadgeMongoRepository },
    { provide: POINTS_REPOSITORY_TOKEN, useClass: PointsMongoRepository },
    { provide: GAME_SESSION_REPOSITORY_TOKEN, useClass: GameSessionMongoRepository },
    RecordGameSessionUseCase, GetChildStatsUseCase, InitializeDefaultBadgesUseCase,
  ],
