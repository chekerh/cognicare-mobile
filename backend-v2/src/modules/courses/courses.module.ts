...
import {
  CourseMongoSchema,
  CourseEnrollmentMongoSchema,
} from "./infrastructure/persistence/mongo/course.schema";
import {
  CourseMongoRepository,
  CourseEnrollmentMongoRepository,
} from "./infrastructure/persistence/mongo/course.mongo-repository";
import {
  COURSE_REPOSITORY_TOKEN,
  COURSE_ENROLLMENT_REPOSITORY_TOKEN,
  CreateCourseUseCase,
  ListCoursesUseCase,
  EnrollCourseUseCase,
...
@Module({
  ...
  providers: [
    ...
    {
      provide: COURSE_ENROLLMENT_REPOSITORY_TOKEN,
      useClass: CourseEnrollmentMongoRepository,
    },
    CreateCourseUseCase,
    ListCoursesUseCase,
    EnrollCourseUseCase,
