...
@Module({
  ...
  providers: [
    { provide: VOLUNTEER_APPLICATION_REPOSITORY_TOKEN, useClass: VolunteerApplicationMongoRepository },
    { provide: VOLUNTEER_TASK_REPOSITORY_TOKEN, useClass: VolunteerTaskMongoRepository },
    GetOrCreateApplicationUseCase,
    UpdateApplicationMeUseCase,
    AddDocumentUseCase,
    RemoveDocumentUseCase,
    ...
    },
    {
      ...
      useFactory: () => {
        return async (_userId: string, _decision: string, _reason?: string) => {};
      },
    },
  ],
  exports: [
