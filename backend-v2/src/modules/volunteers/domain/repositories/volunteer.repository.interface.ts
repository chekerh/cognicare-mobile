import { VolunteerApplicationEntity, VolunteerTaskEntity } from '../entities/volunteer.entity';
...
export interface IVolunteerApplicationRepository {
  ...
  update(entity: VolunteerApplicationEntity): Promise<VolunteerApplicationEntity>;
}
